...
Install Instructions:
    ...
    2. Import the BotCmdSet to your character CmdSet. "self.add(irc2puppetbasic.BotCmdSet())"
...
class AccountBotInputFunctions(Bot):
    ...
    def execute_cmd(self, session=None, txt=None, **kwargs):
        ...
        bot returns to the Account. This is triggered by the bot_data_in
        Inputfunc.
...
class Puppet(Character):
    ...
    the Irc2puppet Bot. Each user on the target IRC channel will be represented by
